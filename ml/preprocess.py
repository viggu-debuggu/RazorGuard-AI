...
MOCK_RAW_TRANSACTIONS = [
    # Safe transactions
    {"amount": 1200.0, "location_drift": 2.5, "velocity_1h": 1, "device_score": 0.1, "status": "Safe"},
    {"amount": 4500.0, "location_drift": 12.0, "velocity_1h": 2, "device_score": 0.15, "status": "Safe"},
    {"amount": 300.0, "location_drift": 0.5, "velocity_1h": 1, "device_score": 0.05, "status": "Safe"},
    {"amount": 8000.0, "location_drift": 45.0, "velocity_1h": 1, "device_score": 0.2, "status": "Safe"},
    
    # Suspicious transactions
    {"amount": 45000.0, "location_drift": 350.0, "velocity_1h": 4, "device_score": 0.45, "status": "Suspicious"},
    {"amount": 75000.0, "location_drift": 180.0, "velocity_1h": 3, "device_score": 0.5, "status": "Suspicious"},
    {"amount": 12000.0, "location_drift": 600.0, "velocity_1h": 5, "device_score": 0.6, "status": "Suspicious"},
    
    # High Risk transactions
    {"amount": 250000.0, "location_drift": 2200.0, "velocity_1h": 8, "device_score": 0.95, "status": "High Risk"},
    {"amount": 490000.0, "location_drift": 4500.0, "velocity_1h": 6, "device_score": 0.85, "status": "High Risk"},
    {"amount": 180000.0, "location_drift": 1500.0, "velocity_1h": 10, "device_score": 0.9, "status": "High Risk"},
]
...
def get_normalization_bounds(data: List[Dict[str, Any]]) -> Dict[str, Tuple[float, float]]:
    ...
    velocities = [x["velocity_1h"] for x in data]
    ...
    return {
        ...
        "velocity_1h": (float(min(velocities)), float(max(velocities))),
